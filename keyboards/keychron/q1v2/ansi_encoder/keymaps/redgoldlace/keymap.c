...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [LACE_BASE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LACE_FN]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)}
};
#endif // ENCODER_MAP_ENABLE

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LACE_BASE] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MO(LACE_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [LACE_FN] = LAYOUT_ansi_82(
